	...
	<div class="container-fluid container_custom">
		<div class="col-md-9 col-xs-12">
			<section>
				<div class="row row-custom_first contenu">
			...
			<div class="row row_custom_second contenu">
				...
				Sean Taylor a monté plusieurs plates-formes sur toute la longueur du Ghana pour des spectacles musicaux et est devenu un nom familier au sein de la fraternité Reggae / Dancehall en ce qui concerne Ghana Reggae / Dancehall. Des chansons comme Everybody Bard, Libérez Jacob, Cleanest People, pas plus que moi, # RichFi2015, Muntaashi et Dem Nuh Bad ont amplifié son image dans la scène.
				</p>
		...
		<div class="imageright">
				...
				<img src ="assets/images/nampage.jpg" width="300px" height="300px">
				Click to listen
			</a>
